...
public class Player2 {
	...
	private int hp = 5;//healthpoint of triple x.
	...
	public void tickTripleX() {
		//updates the coordinate of triple x.
		changeVel(direction);
		x+=velx;
		y+=vely;
		//if triple x hits the wall, change its velocity.
	...
	public void renderTripleX(Graphics g) throws IOException {
		g.drawImage(game.pics.grabTripleX(), (int)x, (int)y, null);
	}
