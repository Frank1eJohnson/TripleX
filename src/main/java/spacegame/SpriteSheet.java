...
public class SpriteSheet {
	...
	public BufferedImage getTripleX() {
		return triplex;
	}
	public void setTripleX(BufferedImage triplex) {
	...
	public BufferedImage grabTripleX() throws IOException {
		//image = loader.loadImage("/TripleX For Space Game.png");
		BufferedImage img = triplex.getSubimage(0, 0, 64, 64);
		return img;
	}
